...
impl CreateResponseRequest {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (model=Self::default().model, input=Self::default().input, instructions=None, tools=None, temperature=None, max_output_tokens=None, metadata=None, stream=None))]
    #[new]
    pub fn new(
        model: String,
        input: String,
