...
impl DefaultClient {
    ...
    #[pyo3(signature = (req))]
    pub fn chat<'py>(&self, _py: Python<'py>, req: ChatCompletionRequest) -> PyResult<Bound<'py, PyAny>> {
        let _ = req;
    ...
    #[allow(clippy::missing_errors_doc)]
    #[pyo3(signature = (req))]
    pub fn embed<'py>(&self, _py: Python<'py>, req: EmbeddingRequest) -> PyResult<Bound<'py, PyAny>> {
        let _ = req;
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
    ...
    #[allow(clippy::missing_errors_doc)]
    #[pyo3(signature = ())]
    pub fn list_models<'py>(&self, _py: Python<'py>) -> PyResult<Bound<'py, PyAny>> {
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
    ...
    #[allow(clippy::missing_errors_doc)]
    #[pyo3(signature = (req))]
    pub fn image_generate<'py>(&self, _py: Python<'py>, req: CreateImageRequest) -> PyResult<Bound<'py, PyAny>> {
        let _ = req;
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
    ...
    #[allow(clippy::missing_errors_doc)]
    #[pyo3(signature = (req))]
    pub fn transcribe<'py>(&self, _py: Python<'py>, req: CreateTranscriptionRequest) -> PyResult<Bound<'py, PyAny>> {
        let _ = req;
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
    ...
    #[allow(clippy::missing_errors_doc)]
    #[pyo3(signature = (req))]
    pub fn moderate<'py>(&self, _py: Python<'py>, req: ModerationRequest) -> PyResult<Bound<'py, PyAny>> {
        let _ = req;
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
    ...
    #[allow(clippy::missing_errors_doc)]
    #[pyo3(signature = (req))]
    pub fn rerank<'py>(&self, _py: Python<'py>, req: RerankRequest) -> PyResult<Bound<'py, PyAny>> {
        let _ = req;
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
    ...
    #[allow(clippy::missing_errors_doc)]
    #[pyo3(signature = (req))]
    pub fn search<'py>(&self, _py: Python<'py>, req: SearchRequest) -> PyResult<Bound<'py, PyAny>> {
        let _ = req;
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
    ...
    #[allow(clippy::missing_errors_doc)]
    #[pyo3(signature = (req))]
    pub fn ocr<'py>(&self, _py: Python<'py>, req: OcrRequest) -> PyResult<Bound<'py, PyAny>> {
        let _ = req;
        Err(pyo3::exceptions::PyNotImplementedError::new_err(
