...
// alef:hash:68b7c15b5ce3e09bfab7658b2a541defb24e02e19d318743c63096e297d54735
...
const __ALEF_WIRE_ASSISTANT_MESSAGE: &[__AlefAlias] = &[];

const __ALEF_WIRE_AUDIO_CONTENT: &[__AlefAlias] = &[];

const __ALEF_WIRE_DEVELOPER_MESSAGE: &[__AlefAlias] = &[];

const __ALEF_WIRE_DOCUMENT_CONTENT: &[__AlefAlias] = &[];

const __ALEF_WIRE_FUNCTION_MESSAGE: &[__AlefAlias] = &[];

const __ALEF_WIRE_IMAGE_URL: &[__AlefAlias] = &[];

const __ALEF_WIRE_JSON_SCHEMA_FORMAT: &[__AlefAlias] = &[];

const __ALEF_WIRE_SPECIFIC_FUNCTION: &[__AlefAlias] = &[];

const __ALEF_WIRE_SPECIFIC_TOOL_CHOICE: &[__AlefAlias] = &[
    __AlefAlias {
        rust: "choice_type",
        wire: "type",
        kind: __AlefKind::Leaf,
        nested: &[],
    },
    __AlefAlias {
        rust: "function",
        ...
        nested: __ALEF_WIRE_SPECIFIC_FUNCTION,
    },
];

const __ALEF_WIRE_SYSTEM_MESSAGE: &[__AlefAlias] = &[];

const __ALEF_WIRE_TOOL_MESSAGE: &[__AlefAlias] = &[];

const __ALEF_WIRE_USER_MESSAGE: &[__AlefAlias] = &[];
...
impl AssistantContent {
    ...
    #[pyo3(name = "from_text")]
    #[staticmethod]
    pub fn _factory_from_text(value: String) -> Self {
        Self {
            inner: liter_llm::types::AssistantContent::Text(value),
        }
    }

    #[pyo3(name = "from_parts")]
    #[staticmethod]
    pub fn _factory_from_parts(value: Vec<AssistantPart>) -> Self {
        Self {
            inner: liter_llm::types::AssistantContent::Parts(value.into_iter().map(Into::into).collect()),
        }
    }
}
...
impl AuthHeaderFormat {
    ...
    #[pyo3(name = "from_api_key")]
    #[staticmethod]
    pub fn _factory_from_api_key(value: String) -> Self {
        Self {
            inner: liter_llm::provider::custom::AuthHeaderFormat::ApiKey(value),
        }
    }
}
...
impl EmbeddingInput {
    ...
    #[pyo3(name = "from_single")]
    #[staticmethod]
    pub fn _factory_from_single(value: String) -> Self {
        Self {
            inner: liter_llm::types::EmbeddingInput::Single(value),
        }
    }

    #[pyo3(name = "from_multiple")]
    #[staticmethod]
    pub fn _factory_from_multiple(value: Vec<String>) -> Self {
        Self {
            inner: liter_llm::types::EmbeddingInput::Multiple(value.into_iter().collect()),
        }
    }

    #[pyo3(name = "from_multimodal")]
    #[staticmethod]
    pub fn _factory_from_multimodal(value: Vec<EmbeddingContentPart>) -> Self {
        Self {
            inner: liter_llm::types::EmbeddingInput::Multimodal(value.into_iter().map(Into::into).collect()),
        }
    }
}
...
impl Message {
    ...
    #[pyo3(name = "from_system")]
    #[staticmethod]
    pub fn _factory_from_system(py: Python<'_>, value: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: liter_llm::types::Message::System(__alef_coerce_dto(py, value, __ALEF_WIRE_SYSTEM_MESSAGE)?),
        })
    }

    #[pyo3(name = "from_user")]
    #[staticmethod]
    pub fn _factory_from_user(py: Python<'_>, value: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: liter_llm::types::Message::User(__alef_coerce_dto(py, value, __ALEF_WIRE_USER_MESSAGE)?),
        })
    }

    #[pyo3(name = "from_assistant")]
    #[staticmethod]
    pub fn _factory_from_assistant(py: Python<'_>, value: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: liter_llm::types::Message::Assistant(__alef_coerce_dto(py, value, __ALEF_WIRE_ASSISTANT_MESSAGE)?),
        })
    }

    #[pyo3(name = "from_tool")]
    #[staticmethod]
    pub fn _factory_from_tool(py: Python<'_>, value: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: liter_llm::types::Message::Tool(__alef_coerce_dto(py, value, __ALEF_WIRE_TOOL_MESSAGE)?),
        })
    }

    #[pyo3(name = "from_developer")]
    #[staticmethod]
    pub fn _factory_from_developer(py: Python<'_>, value: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: liter_llm::types::Message::Developer(__alef_coerce_dto(py, value, __ALEF_WIRE_DEVELOPER_MESSAGE)?),
        })
    }

    #[pyo3(name = "from_function")]
    #[staticmethod]
    pub fn _factory_from_function(py: Python<'_>, value: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: liter_llm::types::Message::Function(__alef_coerce_dto(py, value, __ALEF_WIRE_FUNCTION_MESSAGE)?),
        })
    }
}
...
impl ModerationInput {
    ...
    pub fn _factory_from_single(value: String) -> Self {
        Self {
            inner: liter_llm::types::ModerationInput::Single(value),
        }
    }
    ...
    pub fn _factory_from_multiple(value: Vec<String>) -> Self {
        Self {
            inner: liter_llm::types::ModerationInput::Multiple(value.into_iter().collect()),
        }
    }
}
...
impl RerankDocument {
    ...
    pub fn _factory_from_text(value: String) -> Self {
        Self {
            inner: liter_llm::types::RerankDocument::Text(value),
        }
    }
...
impl StopSequence {
    ...
    pub fn _factory_from_single(value: String) -> Self {
        Self {
            inner: liter_llm::types::StopSequence::Single(value),
        }
    }
    ...
    pub fn _factory_from_multiple(value: Vec<String>) -> Self {
        Self {
            inner: liter_llm::types::StopSequence::Multiple(value.into_iter().collect()),
        }
    }
}
...
impl ToolChoice {
    ...
    #[pyo3(name = "from_mode")]
    #[staticmethod]
    pub fn _factory_from_mode(value: ToolChoiceMode) -> Self {
        Self {
            inner: liter_llm::types::ToolChoice::Mode(value.into()),
        }
    }

    #[pyo3(name = "from_specific")]
    #[staticmethod]
    pub fn _factory_from_specific(py: Python<'_>, value: &Bound<'_, pyo3::types::PyAny>) -> PyResult<Self> {
        Ok(Self {
            inner: liter_llm::types::ToolChoice::Specific(__alef_coerce_dto(
                py,
                value,
                __ALEF_WIRE_SPECIFIC_TOOL_CHOICE,
            )?),
        })
    }
}
...
impl UserContent {
    ...
    pub fn _factory_from_text(value: String) -> Self {
        Self {
            inner: liter_llm::types::UserContent::Text(value),
        }
    }

    #[pyo3(name = "from_parts")]
    #[staticmethod]
    pub fn _factory_from_parts(value: Vec<ContentPart>) -> Self {
        Self {
            inner: liter_llm::types::UserContent::Parts(value.into_iter().map(Into::into).collect()),
        }
    }
}
