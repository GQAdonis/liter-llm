...
impl LlmProviderConfig {
    ...
    #[php(constructor)]
    pub fn new(name: String, baseUrl: String, authHeader: Option<String>, modelPrefixes: Vec<String>) -> Self {
        Self {
            name,
            base_url: baseUrl,
...
impl BudgetConfig {
    ...
    #[php(constructor)]
    pub fn new(globalLimit: Option<f64>, modelLimits: HashMap<String, f64>, enforcement: String) -> Self {
        Self {
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("liter_llm", "1.16.0")
