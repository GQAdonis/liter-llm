...
// alef:hash:153a3de19a794e57a4943431f29e86be63d9f4e3c70d9189d9d69626c018700a
...
impl ContentPart {
    ...
    #[php(name = "text")]
    pub fn _factory_text(text: String) -> Self {
        liter_llm::types::ContentPart::Text { text: text }.into()
    }
...
impl EmbeddingContentPart {
    ...
    #[php(name = "text")]
    pub fn _factory_text(text: String) -> Self {
        liter_llm::types::EmbeddingContentPart::Text { text: text }.into()
    }
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("liter_llm", "1.18.1")
