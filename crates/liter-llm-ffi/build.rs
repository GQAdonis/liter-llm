...
// alef:hash:52ceb1e3c9746f30645b8786e2f1bdbb6a0493bbbf80271695d9d0f2e791e1c4
...
fn main() {
    ...
    // `#if defined(LITERLLM_FEATURE_X)` (its `[defines]` table), and it does so from
    ...
    {
        let header_path = "include/liter_llm.h";
    ...
    // `binding.go` carries `#include "liter_llm.h"` under cgo, so the header has to be
