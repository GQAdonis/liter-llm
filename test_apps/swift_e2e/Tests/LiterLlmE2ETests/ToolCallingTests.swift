...
// alef:hash:576a73966e72413e227533df3261eb6b3efc1a8e52cdfaaaff38814df2dff5f1
...
final class ToolCallingTests: XCTestCase {
    ...
    func testAnthropicToolCalling() async throws {
        ...
        XCTAssertEqual(_vec_choices_equals_12e4bfba[0].message().toolCalls()?[0].function().name().toString(), "get_weather")
