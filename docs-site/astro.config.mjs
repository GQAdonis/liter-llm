  ...
  integrations : [
    starlight(
        xbergStarlightConfig({
          ...
          editBaseUrl :
              "https://github.com/xberg-io/liter-llm/edit/main/docs-site/",
          plugins : [
            starlightLlmsTxt({
              customSets : [
                {
                  label : "Get Started",
                  description :
                      "Install liter-llm for your language and make a first call.",
                ...
                },
                {
                  label : "Concepts",
                  description :
                      "Architecture, feature flags, the tokenizer model, and cost estimation.",
                  paths : [ "concepts/**" ],
                },
                {
                  label : "Reference",
                  description :
                      "Per-language API reference, the provider list, CLI, MCP, configuration, " +
                          "types, and errors.",
                ...
                },
                {
                  label : "More",
                  description :
                      "Contributing, changelog, and the Xberg.io ecosystem.",
