...
<!-- alef:hash:0eec985dff0870d6eff0e727ba49d8293e2c097749760bd6448664f59e5ebaa0 -->
...
| Variant | Wire value | Description |
|---------|------------|-------------|
| `System` | `system` | System — Fields (flattened into the tagged object): `content`: `UserContent`, `name`: `String` |
| `User` | `user` | User — Fields (flattened into the tagged object): `content`: `UserContent`, `name`: `String` |
| `Assistant` | `assistant` | Assistant — Fields (flattened into the tagged object): `content`: `AssistantContent`, `name`: `String`, `tool_calls`: `Vec<ToolCall>`, `refusal`: `String`, `function_call`: `FunctionCall`, `reasoning_content`: `String` |
| `Tool` | `tool` | Tool — Fields (flattened into the tagged object): `content`: `UserContent`, `tool_call_id`: `String`, `name`: `String` |
| `Developer` | `developer` | Developer — Fields (flattened into the tagged object): `content`: `String`, `name`: `String` |
| `Function` | `function` | Deprecated legacy function-role message; retained for API compatibility. — Fields (flattened into the tagged object): `content`: `String`, `name`: `String` |
