...
<!-- alef:hash:87126b8867164d1a128f63178845bf938cac5114a9d10efe51fe0527baba1e4a -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Zig API Reference <span class="version-badge">v2.1.1</span>
...
| Value | Description |
|-------|-------------|
| `system` | System — Fields (flattened into the tagged object): `content`: `UserContent`, `name`: `[]const u8` |
| `user` | User — Fields (flattened into the tagged object): `content`: `UserContent`, `name`: `[]const u8` |
| `assistant` | Assistant — Fields (flattened into the tagged object): `content`: `AssistantContent`, `name`: `[]const u8`, `tool_calls`: `[]const ToolCall`, `refusal`: `[]const u8`, `function_call`: `FunctionCall`, `reasoning_content`: `[]const u8` |
| `tool` | Tool — Fields (flattened into the tagged object): `content`: `UserContent`, `tool_call_id`: `[]const u8`, `name`: `[]const u8` |
| `developer` | Developer — Fields (flattened into the tagged object): `content`: `[]const u8`, `name`: `[]const u8` |
| `function` | Deprecated legacy function-role message; retained for API compatibility. — Fields (flattened into the tagged object): `content`: `[]const u8`, `name`: `[]const u8` |
