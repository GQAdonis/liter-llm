...
<!-- alef:hash:3d9ed300c615c8d499f0872d3ec56dc2703831b90ead9cd95ba5ae55011ab52d -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Elixir API Reference <span class="version-badge">v2.1.1</span>
...
| Value | Description |
|-------|-------------|
| `system` | System — Fields (flattened into the tagged object): `content`: `UserContent`, `name`: `String.t()` |
| `user` | User — Fields (flattened into the tagged object): `content`: `UserContent`, `name`: `String.t()` |
| `assistant` | Assistant — Fields (flattened into the tagged object): `content`: `AssistantContent`, `name`: `String.t()`, `tool_calls`: `list(ToolCall)`, `refusal`: `String.t()`, `function_call`: `FunctionCall`, `reasoning_content`: `String.t()` |
| `tool` | Tool — Fields (flattened into the tagged object): `content`: `UserContent`, `tool_call_id`: `String.t()`, `name`: `String.t()` |
| `developer` | Developer — Fields (flattened into the tagged object): `content`: `String.t()`, `name`: `String.t()` |
| `function` | Deprecated legacy function-role message; retained for API compatibility. — Fields (flattened into the tagged object): `content`: `String.t()`, `name`: `String.t()` |
