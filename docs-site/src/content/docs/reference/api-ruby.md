...
<!-- alef:hash:3e1a2c8c155c6306f2d2d8409a6401acd5dc260aaed298a92dec5316b8c50916 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Ruby API Reference <span class="version-badge">v2.1.1</span>
...
| `assistant` | Assistant — Fields (flattened into the tagged object): `content`: `AssistantContent`, `name`: `String`, `tool_calls`: `Array<ToolCall>`, `refusal`: `String`, `function_call`: `FunctionCall`, `reasoning_content`: `String` |
| `tool` | Tool — Fields (flattened into the tagged object): `content`: `UserContent`, `tool_call_id`: `String`, `name`: `String` |
