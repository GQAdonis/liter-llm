...
<!-- alef:hash:e82c942e0f0a0c9ec32b111486d8eef8533ea7f29381ba2440227749c0b35081 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Python API Reference <span class="version-badge">v2.1.0</span>
...
| Value | Description |
|-------|-------------|
| `SYSTEM` | System — Fields (flattened into the tagged object): `content`: `UserContent`, `name`: `str` |
| `USER` | User — Fields (flattened into the tagged object): `content`: `UserContent`, `name`: `str` |
| `ASSISTANT` | Assistant — Fields (flattened into the tagged object): `content`: `AssistantContent`, `name`: `str`, `tool_calls`: `list[ToolCall]`, `refusal`: `str`, `function_call`: `FunctionCall`, `reasoning_content`: `str` |
| `TOOL` | Tool — Fields (flattened into the tagged object): `content`: `UserContent`, `tool_call_id`: `str`, `name`: `str` |
| `DEVELOPER` | Developer — Fields (flattened into the tagged object): `content`: `str`, `name`: `str` |
| `FUNCTION` | Deprecated legacy function-role message; retained for API compatibility. — Fields (flattened into the tagged object): `content`: `str`, `name`: `str` |
