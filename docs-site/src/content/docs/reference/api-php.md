...
<!-- alef:hash:e576235a540a9b1394172753d92305bc8177e3b091212f85c82fb2abe8693765 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## PHP API Reference <span class="version-badge">v2.1.1</span>
...
| Value | Description |
|-------|-------------|
| `System` | System — Fields (flattened into the tagged object): `content`: `UserContent`, `name`: `string` |
| `User` | User — Fields (flattened into the tagged object): `content`: `UserContent`, `name`: `string` |
| `Assistant` | Assistant — Fields (flattened into the tagged object): `content`: `AssistantContent`, `name`: `string`, `toolCalls`: `array<ToolCall>`, `refusal`: `string`, `functionCall`: `FunctionCall`, `reasoningContent`: `string` |
| `Tool` | Tool — Fields (flattened into the tagged object): `content`: `UserContent`, `toolCallId`: `string`, `name`: `string` |
| `Developer` | Developer — Fields (flattened into the tagged object): `content`: `string`, `name`: `string` |
| `Function` | Deprecated legacy function-role message; retained for API compatibility. — Fields (flattened into the tagged object): `content`: `string`, `name`: `string` |
