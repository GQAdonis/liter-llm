...
## Rust API Reference <span class="version-badge">v1.16.0</span>
...
```rust
pub fn create_client(api_key: &str, base_url: Option<String>, timeout_secs: Option<u64>, max_retries: Option<u32>, model_hint: Option<String>) -> Result<DefaultClient, LiterLlmError>
```
