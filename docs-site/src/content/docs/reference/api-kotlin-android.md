...
<!-- alef:hash:551ab59231a2bdd871125ebf73a5509cfe3268eda36a311954f4ca7b542afc24 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Kotlin (Android) API Reference <span class="version-badge">v2.1.1</span>
...
| `Assistant` | Assistant — Fields (flattened into the tagged object): `content`: `AssistantContent`, `name`: `String`, `toolCalls`: `List<ToolCall>`, `refusal`: `String`, `functionCall`: `FunctionCall`, `reasoningContent`: `String` |
