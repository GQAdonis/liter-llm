...
import { Content as Snip_python_usage_local_llm } from "../../../snippets/python/configuration/local-provider-ollama.md";
import { Content as Snip_typescript_usage_local_llm } from "../../../snippets/typescript/configuration/local-provider-ollama.md";
import { Content as Snip_rust_usage_local_llm } from "../../../snippets/rust/configuration/local-provider-ollama.md";
import { Content as Snip_go_usage_local_llm } from "../../../snippets/go/configuration/local-provider-ollama.md";
