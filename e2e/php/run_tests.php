...
// alef:hash:960a32dbb29923a38618793b10360db49f355cd6f20445e478d877cac99f45e8
...
if (!$pieInstalledExtPath && $resolvePieFromExtensionDir) {
    ...
    if ($registryExtDir !== '') {
        $pieInstalledExtPath = $registryExtDir . '/liter_llm.so';
    }
}
...
if ($loadedVersion !== '2.1.0') {
    ...
    fwrite(STDERR, "  expected version: 2.1.0\n");
