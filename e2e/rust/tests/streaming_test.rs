...
// alef:hash:208765eb72ec6049b24b15050386e122ffb3791c00413919f713b03d39c43132
...
async fn test_stream_with_tool_calls() {
    ...
    let chunks: Vec<_> = tokio_stream::StreamExt::collect::<Vec<_>>(stream)
        ...
        .map(|r| r.expect("stream item failed"))
        .collect();
    let _finish_reason = result.finish_reason.as_ref().map(|v| v.to_string()).unwrap_or_default();
