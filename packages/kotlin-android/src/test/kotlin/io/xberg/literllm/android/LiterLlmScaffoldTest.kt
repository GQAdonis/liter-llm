...
class LiterLlmScaffoldTest {
    // Round-trips the generated `DocumentContent` data class through the Jackson mapping the
    ...
    @Test
    fun documentContentRoundTripsThroughItsGeneratedJsonMapping() {
        val original = DocumentContent("alef-scaffold", "alef-scaffold")
        ...
        assertEquals(original, mapper.readValue(json, DocumentContent::class.java))
    }
}
