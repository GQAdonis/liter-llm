...
// alef:hash:020465ba43917a14551c6b98a646ae786bc9d7b5fbcfb3f749c1423ce0ed86fa
...
impl From<liter_llm::types::EmbeddingContentPart> for EmbeddingContentPart {
    fn from(v: liter_llm::types::EmbeddingContentPart) -> Self {
        match v {
            liter_llm::types::EmbeddingContentPart::Text { text } => EmbeddingContentPart::Text { text: text },
            liter_llm::types::EmbeddingContentPart::ImageUrl { image_url } => EmbeddingContentPart::ImageUrl {
                image_url: ImageUrl::from(image_url),
            },
            liter_llm::types::EmbeddingContentPart::ImageBase64 { image_base64 } => EmbeddingContentPart::ImageBase64 {
...
impl From<EmbeddingContentPart> for liter_llm::types::EmbeddingContentPart {
    fn from(v: EmbeddingContentPart) -> Self {
        match v {
            EmbeddingContentPart::Text { text } => liter_llm::types::EmbeddingContentPart::Text { text: text },
            EmbeddingContentPart::ImageUrl { image_url } => liter_llm::types::EmbeddingContentPart::ImageUrl {
                image_url: image_url.into(),
            },
            EmbeddingContentPart::ImageBase64 { image_base64 } => liter_llm::types::EmbeddingContentPart::ImageBase64 {
                image_base64: image_base64,
            },
        }
    }
