...
impl LlmConfig {
    pub fn new(
        ...
        let mut __target: liter_llm::client::LlmConfig = ::std::default::Default::default();
        {
            // Try JSON parse first (handles enum/object values); on parse failure
            // treat the raw input as a JSON string scalar so plain `String` /
            // string-like enum fields don't end up empty for inputs that aren't
        ...
        if let Some(w) = cache {
            __target.cache = Some(w.0);
        }
        if let Some(w) = budget {
            __target.budget = Some(w.0);
        }
...
impl LlmCacheConfig {
    pub fn new(
        ...
        let mut __target: liter_llm::client::LlmCacheConfig = ::std::default::Default::default();
...
impl LlmBudgetConfig {
    pub fn new(global_limit: Option<f64>, model_limits: String, enforcement: Option<String>) -> LlmBudgetConfig {
        let mut __target: liter_llm::client::LlmBudgetConfig = ::std::default::Default::default();
