...
// alef:hash:58554ef9470d4431b897b812e352bdb57eb4d38e41fe8542d81cf41c9a69e036
...
#[allow(dead_code)]
fn __alef_image_detail_from_swift_string(value: &str) -> liter_llm::types::ImageDetail {
    match value {
        "low" => liter_llm::types::ImageDetail::Low,
        "high" => liter_llm::types::ImageDetail::High,
        "auto" => liter_llm::types::ImageDetail::Auto,
        _ => panic!("unknown ImageDetail variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_tool_type_from_swift_string(value: &str) -> liter_llm::types::ToolType {
    match value {
        "function" => liter_llm::types::ToolType::Function,
        _ => panic!("unknown ToolType variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_tool_choice_mode_from_swift_string(value: &str) -> liter_llm::types::ToolChoiceMode {
    match value {
        "auto" => liter_llm::types::ToolChoiceMode::Auto,
        "required" => liter_llm::types::ToolChoiceMode::Required,
        "none" => liter_llm::types::ToolChoiceMode::None,
        _ => panic!("unknown ToolChoiceMode variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_modality_from_swift_string(value: &str) -> liter_llm::types::Modality {
    match value {
        "text" => liter_llm::types::Modality::Text,
        "audio" => liter_llm::types::Modality::Audio,
        "image" => liter_llm::types::Modality::Image,
        _ => panic!("unknown Modality variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_finish_reason_from_swift_string(value: &str) -> liter_llm::types::FinishReason {
    match value {
        ...
        _ => panic!("unknown FinishReason variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_reasoning_effort_from_swift_string(value: &str) -> liter_llm::types::ReasoningEffort {
    match value {
        ...
        "minimal" => liter_llm::types::ReasoningEffort::Minimal,
        "max" => liter_llm::types::ReasoningEffort::Max,
        _ => panic!("unknown ReasoningEffort variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_embedding_format_from_swift_string(value: &str) -> liter_llm::types::EmbeddingFormat {
    match value {
        "float" => liter_llm::types::EmbeddingFormat::Float,
        "base64" => liter_llm::types::EmbeddingFormat::Base64,
        _ => panic!("unknown EmbeddingFormat variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_file_purpose_from_swift_string(value: &str) -> liter_llm::types::FilePurpose {
    match value {
        ...
        _ => panic!("unknown FilePurpose variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_batch_status_from_swift_string(value: &str) -> liter_llm::types::BatchStatus {
    match value {
        ...
        _ => panic!("unknown BatchStatus variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_stream_format_from_swift_string(value: &str) -> liter_llm::provider::StreamFormat {
    match value {
        "sse" => liter_llm::provider::StreamFormat::Sse,
        "aws_event_stream" => liter_llm::provider::StreamFormat::AwsEventStream,
        _ => panic!("unknown StreamFormat variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_auth_type_from_swift_string(value: &str) -> liter_llm::provider::AuthType {
    match value {
        ...
        _ => panic!("unknown AuthType variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_enforcement_from_swift_string(value: &str) -> liter_llm::Enforcement {
    match value {
        "Hard" => liter_llm::Enforcement::Hard,
        "Soft" => liter_llm::Enforcement::Soft,
        _ => panic!("unknown Enforcement variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_circuit_state_from_swift_string(value: &str) -> liter_llm::tower::CircuitState {
    match value {
        "Closed" => liter_llm::tower::CircuitState::Closed,
        "Open" => liter_llm::tower::CircuitState::Open,
        "HalfOpen" => liter_llm::tower::CircuitState::HalfOpen,
        _ => panic!("unknown CircuitState variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_health_status_from_swift_string(value: &str) -> liter_llm::tower::HealthStatus {
    match value {
        "Healthy" => liter_llm::tower::HealthStatus::Healthy,
        "Unhealthy" => liter_llm::tower::HealthStatus::Unhealthy,
        _ => panic!("unknown HealthStatus variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_refresh_outcome_from_swift_string(value: &str) -> liter_llm::cost::refresh::RefreshOutcome {
    match value {
        "Disabled" => liter_llm::cost::refresh::RefreshOutcome::Disabled,
        "FromCache" => liter_llm::cost::refresh::RefreshOutcome::FromCache,
        "Fetched" => liter_llm::cost::refresh::RefreshOutcome::Fetched,
        _ => panic!("unknown RefreshOutcome variant: {}", value),
    }
}
