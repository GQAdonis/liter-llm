...
// alef:hash:17a3818439d042ff23ea1009c653ec465d882fbbbf2471fecf21c8866f71df2f
...
public struct BudgetConfig: Codable, Sendable, Hashable {
    ...
    public init(globalLimit: Double? = nil, modelLimits: [String: Double], enforcement: Enforcement) {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.modelLimits = try container.decodeIfPresent([String: Double].self, forKey: .modelLimits) ?? [:]
        self.enforcement = try container.decode(Enforcement.self, forKey: .enforcement)
    }
}

// MARK: - Internal FFI conversions for BudgetConfig
internal extension BudgetConfig {
    init(_ rb: RustBridge.BudgetConfigRef) throws {
        ...
        self.enforcement = try { let rawValue = rb.enforcement().toString(); guard let value = Enforcement(rawValue: rawValue) else { throw CatalogRefreshError.validation(message: "Unknown Enforcement variant", source: rawValue) }; return value }()
    }

    func intoRust() throws -> RustBridge.BudgetConfig {
        let data = try JSONEncoder().encode(self)
        let json = String(data: data, encoding: .utf8) ?? "{}"
...
public struct LlmConfig: Codable, Sendable, Hashable {
    ...
    public let loadEnv: Bool?
    /// Extra headers sent on every request.
    public let headers: [String: String]?
    /// Custom provider configurations, in addition to the built-in providers.
    public let providers: [LlmProviderConfig]?
    /// Response cache configuration.
    public let cache: LlmCacheConfig?
    /// Budget enforcement configuration.
    public let budget: LlmBudgetConfig?
    /// Per-model rate limiting configuration.
    public let rateLimit: LlmRateLimitConfig?
    /// Global per-client in-flight provider request limit.
    public let inFlightLimit: LlmInFlightLimitConfig?
    /// Enable per-request cost tracking.
    public let costTracking: Bool?
    /// Enable OpenTelemetry-compatible tracing spans.
    public let tracing: Bool?
    /// Cooldown duration after transient errors, in seconds.
    public let cooldownSecs: UInt64?
    /// Background health check interval, in seconds.
    public let healthCheckSecs: UInt64?
    /// AWS Bedrock configuration (region, credentials, cross-region routing).
    public let bedrock: BedrockConfig?
    public init(model: String, apiKey: String? = nil, baseUrl: String? = nil, timeoutSecs: UInt64? = nil, maxRetries: UInt32? = nil, temperature: Double? = nil, maxTokens: UInt64? = nil, loadEnv: Bool? = nil, headers: [String: String]? = nil, providers: [LlmProviderConfig]? = nil, cache: LlmCacheConfig? = nil, budget: LlmBudgetConfig? = nil, rateLimit: LlmRateLimitConfig? = nil, inFlightLimit: LlmInFlightLimitConfig? = nil, costTracking: Bool? = nil, tracing: Bool? = nil, cooldownSecs: UInt64? = nil, healthCheckSecs: UInt64? = nil, bedrock: BedrockConfig? = nil) {
        self.model = model
        self.apiKey = apiKey
        self.baseUrl = baseUrl
        ...
        self.healthCheckSecs = healthCheckSecs
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case loadEnv = "load_env"
        case headers = "headers"
        case providers = "providers"
        case cache = "cache"
        case budget = "budget"
        case rateLimit = "rate_limit"
        case inFlightLimit = "in_flight_limit"
        case costTracking = "cost_tracking"
        case tracing = "tracing"
        case cooldownSecs = "cooldown_secs"
        case healthCheckSecs = "health_check_secs"
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.loadEnv = try container.decodeIfPresent(Bool.self, forKey: .loadEnv) ?? nil
        self.headers = try container.decodeIfPresent([String: String].self, forKey: .headers) ?? nil
        self.providers = try container.decodeIfPresent([LlmProviderConfig].self, forKey: .providers) ?? nil
        self.cache = try container.decodeIfPresent(LlmCacheConfig.self, forKey: .cache) ?? nil
        self.budget = try container.decodeIfPresent(LlmBudgetConfig.self, forKey: .budget) ?? nil
        self.rateLimit = try container.decodeIfPresent(LlmRateLimitConfig.self, forKey: .rateLimit) ?? nil
        self.inFlightLimit = try container.decodeIfPresent(LlmInFlightLimitConfig.self, forKey: .inFlightLimit) ?? nil
        self.costTracking = try container.decodeIfPresent(Bool.self, forKey: .costTracking) ?? nil
        self.tracing = try container.decodeIfPresent(Bool.self, forKey: .tracing) ?? nil
        self.cooldownSecs = try container.decodeIfPresent(UInt64.self, forKey: .cooldownSecs) ?? nil
        self.healthCheckSecs = try container.decodeIfPresent(UInt64.self, forKey: .healthCheckSecs) ?? nil
        self.bedrock = try container.decodeIfPresent(BedrockConfig.self, forKey: .bedrock) ?? nil
    }
}
...
internal extension LlmConfig {
    init(_ rb: RustBridge.LlmConfigRef) throws {
        ...
        self.loadEnv = rb.loadEnv()
        self.headers = try JSONDecoder().decode([String: String]?.self, from: ((rb.headers().toString()).data(using: .utf8) ?? Data("null".utf8)))
        self.providers = try JSONDecoder().decode([LlmProviderConfig]?.self, from: ((rb.providers().toString()).data(using: .utf8) ?? Data("null".utf8)))
        self.cache = try rb.cache().map { try LlmCacheConfig($0) }
        self.budget = try rb.budget().map { try LlmBudgetConfig($0) }
        self.rateLimit = try rb.rateLimit().map { try LlmRateLimitConfig($0) }
        self.inFlightLimit = try rb.inFlightLimit().map { try LlmInFlightLimitConfig($0) }
        self.costTracking = rb.costTracking()
        self.tracing = rb.tracing()
        self.cooldownSecs = rb.cooldownSecs()
        self.healthCheckSecs = rb.healthCheckSecs()
        self.bedrock = try rb.bedrock().map { try BedrockConfig($0) }
    }
...
public struct OcrImage: Codable, Sendable, Hashable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.imageBase64 = try container.decodeIfPresent(String.self, forKey: .imageBase64) ?? nil
    }
}
...
public struct OcrPage: Codable, Sendable, Hashable {
    ...
    public init(from decoder: any Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.index = try container.decode(UInt32.self, forKey: .index)
        self.markdown = try container.decode(String.self, forKey: .markdown)
        self.images = try container.decodeIfPresent([OcrImage].self, forKey: .images) ?? nil
...
public struct OcrResponse: Codable, Sendable, Hashable {
    ...
    public init(from decoder: any Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.pages = try container.decode([OcrPage].self, forKey: .pages)
        self.model = try container.decode(String.self, forKey: .model)
        self.usage = try container.decodeIfPresent(Usage.self, forKey: .usage) ?? nil
    }
}
...
public struct ProviderConfig: Codable, Sendable, Hashable {
    ...
    public let paramMappings: [String: String]?
    public init(name: String, displayName: String? = nil, baseUrl: String? = nil, auth: AuthConfig? = nil, endpoints: [String]? = nil, modelPrefixes: [String]? = nil, paramMappings: [String: String]? = nil) {
        self.name = name
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case modelPrefixes = "model_prefixes"
        case paramMappings = "param_mappings"
    }
}

// MARK: - Internal FFI conversions for ProviderConfig
internal extension ProviderConfig {
    init(_ rb: RustBridge.ProviderConfigRef) throws {
        self.name = rb.name().toString()
        self.displayName = rb.displayName()?.toString()
        self.baseUrl = rb.baseUrl()?.toString()
        self.auth = try rb.auth().map { try AuthConfig($0) }
        self.endpoints = try JSONDecoder().decode([String]?.self, from: ((rb.endpoints().toString()).data(using: .utf8) ?? Data("null".utf8)))
        self.modelPrefixes = try JSONDecoder().decode([String]?.self, from: ((rb.modelPrefixes().toString()).data(using: .utf8) ?? Data("null".utf8)))
        self.paramMappings = try JSONDecoder().decode([String: String]?.self, from: ((rb.paramMappings().toString()).data(using: .utf8) ?? Data("null".utf8)))
    }

    func intoRust() throws -> RustBridge.ProviderConfig {
        let data = try JSONEncoder().encode(self)
        let json = String(data: data, encoding: .utf8) ?? "{}"
...
public struct RerankResult: Codable, Sendable, Hashable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.document = try container.decodeIfPresent(RerankResultDocument.self, forKey: .document) ?? nil
    }
}
...
public struct SearchResult: Codable, Sendable, Hashable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.date = try container.decodeIfPresent(String.self, forKey: .date) ?? nil
    }
}
...
public typealias BudgetConfigRef = RustBridge.BudgetConfigRef

public typealias BudgetConfigRefMut = RustBridge.BudgetConfigRefMut
...
public typealias ProviderConfigRef = RustBridge.ProviderConfigRef

public typealias ProviderConfigRefMut = RustBridge.ProviderConfigRefMut
...
public enum AuthHeaderFormat: Codable, Sendable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "ApiKey":
            self = .apiKey(field0: try container.decode(String.self, forKey: key))
        default:
            throw DecodingError.dataCorrupted(
...
public enum Message: Codable, Sendable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        switch type {
        case "system":
            self = .system(field0: try SystemMessage(from: decoder))
        case "user":
            self = .user(field0: try UserMessage(from: decoder))
        case "assistant":
            self = .assistant(field0: try AssistantMessage(from: decoder))
        case "tool":
            self = .tool(field0: try ToolMessage(from: decoder))
        case "developer":
            self = .developer(field0: try DeveloperMessage(from: decoder))
        case "function":
            self = .function(field0: try FunctionMessage(from: decoder))
        default:
            throw DecodingError.dataCorruptedError(
                forKey: .role,
                in: container,
...
public func budgetConfigFromJson(_ json: String) throws -> BudgetConfig {
    let data = json.data(using: .utf8) ?? Data()
    return try JSONDecoder().decode(BudgetConfig.self, from: data)
}
