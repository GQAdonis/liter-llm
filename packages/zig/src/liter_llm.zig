...
// alef:hash:271380e960bc6b397498f8c0b4c09e8076041e11cb8cb54508bec4c3ce1eabc5
...
pub const DefaultClient = struct {
    ...
    pub fn chat(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        defer c.literllm_chat_completion_request_free(req_handle);
        const _result = c.literllm_default_client_chat(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn chat_stream(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})!ChatCompletionChunkStream {
        ...
        if (req_handle == null) { return _first_error(LiterLlmError); }
        defer c.literllm_chat_completion_request_free(req_handle);
        const _stream_handle = c.literllm_default_client_chat_stream_start(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
    ...
    pub fn embed(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_embed(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn list_models(self: *DefaultClient) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.literllm_default_client_list_models(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)));
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn image_generate(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_image_generate(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn speech(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        _ = c.literllm_default_client_speech(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle, &_out_ptr, &_out_len, &_out_cap);
        if (c.literllm_last_error_code() != 0) {
            return _error_with_message(LiterLlmError);
        }
    ...
    pub fn transcribe(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_transcribe(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn moderate(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_moderate(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn rerank(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_rerank(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn search(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_search(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn ocr(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_ocr(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn create_file(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_create_file(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn retrieve_file(self: *DefaultClient, file_id: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_retrieve_file(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), file_id_z);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn delete_file(self: *DefaultClient, file_id: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const file_id_z = try std.heap.c_allocator.dupeZ(u8, file_id);
        defer std.heap.c_allocator.free(file_id_z);
        const _result = c.literllm_default_client_delete_file(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), file_id_z);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn list_files(self: *DefaultClient, query: ?[]const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_list_files(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), query_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn file_content(self: *DefaultClient, file_id: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        var _out_len: usize = 0;
        var _out_cap: usize = 0;
        _ = c.literllm_default_client_file_content(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), file_id_z, &_out_ptr, &_out_len, &_out_cap);
        if (c.literllm_last_error_code() != 0) {
            return _error_with_message(LiterLlmError);
        }
        const _owned = try std.heap.c_allocator.dupe(u8, _out_ptr[0.._out_len]);
    ...
    pub fn create_batch(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_create_batch(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn retrieve_batch(self: *DefaultClient, batch_id: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_retrieve_batch(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), batch_id_z);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn list_batches(self: *DefaultClient, query: ?[]const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_list_batches(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), query_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn cancel_batch(self: *DefaultClient, batch_id: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const batch_id_z = try std.heap.c_allocator.dupeZ(u8, batch_id);
        defer std.heap.c_allocator.free(batch_id_z);
        const _result = c.literllm_default_client_cancel_batch(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), batch_id_z);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn fetch_batch_for_polling(self: *DefaultClient, batch_id: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const batch_id_z = try std.heap.c_allocator.dupeZ(u8, batch_id);
        defer std.heap.c_allocator.free(batch_id_z);
        const _result = c.literllm_default_client_fetch_batch_for_polling(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), batch_id_z);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn wait_for_batch(self: *DefaultClient, batch_id: []const u8, config: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        const handle = self._handle orelse return error.HandleClosed;
        const batch_id_z = try std.heap.c_allocator.dupeZ(u8, batch_id);
        defer std.heap.c_allocator.free(batch_id_z);
        ...
        const _result = c.literllm_default_client_wait_for_batch(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), batch_id_z, config_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn create_response(self: *DefaultClient, req: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_create_response(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), req_handle);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn retrieve_response(self: *DefaultClient, response_id: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const _result = c.literllm_default_client_retrieve_response(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), response_id_z);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn cancel_response(self: *DefaultClient, response_id: []const u8) (LiterLlmError||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        const response_id_z = try std.heap.c_allocator.dupeZ(u8, response_id);
        defer std.heap.c_allocator.free(response_id_z);
        const _result = c.literllm_default_client_cancel_response(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)), response_id_z);
        if (_result == null) {
            return _first_error(LiterLlmError);
        }
        return blk: {
    ...
    pub fn free(self: *DefaultClient) void {
        const handle = self._handle orelse return;
        self._handle = null;
        c.literllm_default_client_free(@as(*c.LITERLLMDefaultClient, @ptrCast(handle)));
    }
};
...
pub const SingleflightResult = struct {
    ...
    pub fn free(self: *SingleflightResult) void {
        const handle = self._handle orelse return;
        self._handle = null;
        c.literllm_singleflight_result_free(@as(*c.LITERLLMSingleflightResult, @ptrCast(handle)));
    }
};
...
pub const IntentPrototype = struct {
    ...
    pub fn free(self: *IntentPrototype) void {
        const handle = self._handle orelse return;
        self._handle = null;
        c.literllm_intent_prototype_free(@as(*c.LITERLLMIntentPrototype, @ptrCast(handle)));
    }
};
