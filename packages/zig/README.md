...
<!-- alef:hash:989771be083fdaeabcf121b4b751d7882e686dd707e4b311b4f5e43a40b117bc -->
...
```bash
zig fetch --save https://github.com/xberg-io/liter-llm/archive/refs/tags/v2.1.0.tar.gz
```
